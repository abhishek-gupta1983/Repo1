...
config.update({'sqlalchemy.dburi':'mysql://web_backend:web_backend@localhost:3306/test_model'})
# config.update_config(configfile="D:\\temp\\model_pkg\\TG_App\\dev.cfg", modulename="TG_App.config")
...
tg = tg_usage.tg_init(engine=get_engine(), metadata=metadata, session=session, sa_mapper=mapper)
print tg
from model.schema_decl.schema_declarative import *
