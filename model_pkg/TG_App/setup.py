...
execfile(os.path.join('TG_App', 'release.py'))

packages = find_packages()
package_data = find_package_data(where='TG_App',
    package='TG_App')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-TG_App = TG_App.command:start',
            # See the TG_App.command.bootstrap function for details
