...
execfile(os.path.join('Chatty', 'release.py'))

packages = find_packages()
package_data = find_package_data(where='Chatty',
    package='Chatty')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-Chatty = Chatty.command:start',
            # See the Chatty.command.bootstrap function for details
